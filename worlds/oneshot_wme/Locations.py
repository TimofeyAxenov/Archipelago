...
crafts_locations = {
    ...
    "Button (?)":            LocData(LOC_ID_BASE + 112, "Refuge Upper"),
    "Magnetized Button":     LocData(LOC_ID_BASE + 113, "Refuge Upper"),
    "Taped Button":          LocData(LOC_ID_BASE + 114, "Refuge Upper"),
    "Niko Library Card":     LocData(LOC_ID_BASE + 115, "Refuge Lower"),
    "Sticky Photo Craft":    LocData(LOC_ID_BASE + 116, "Refuge Lower"),
    "Medicated Water Craft": LocData(LOC_ID_BASE + 117, "Refuge Lower"),
}
