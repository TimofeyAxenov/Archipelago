...
# ── Refuge ────────────────────────────────────────────────────────────────────
refuge_locations = {
    "Scissors":                     LocData(LOC_ID_BASE + 50, "Refuge Upper"),
    "Dirt":                         LocData(LOC_ID_BASE + 51, "Refuge Upper"),
    "Magnets":                      LocData(LOC_ID_BASE + 52, "Refuge Upper"),
    "Metal Can":                    LocData(LOC_ID_BASE + 54, "Refuge Upper"),
    "Weird Film":                   LocData(LOC_ID_BASE + 55, "Refuge Upper"),
    "Concave Lens":                 LocData(LOC_ID_BASE + 56, "Refuge Lower"),
    "Convex Lens":                  LocData(LOC_ID_BASE + 57, "Refuge Lower"),
    "Thin Lens":                    LocData(LOC_ID_BASE + 58, "Refuge Lower"),
    "Thick Lens":                   LocData(LOC_ID_BASE + 59, "Refuge Lower"),
    "Glitter Glue":                 LocData(LOC_ID_BASE + 60, "Refuge Lower"),
    "Kip's Library Card":           LocData(LOC_ID_BASE + 61, "Refuge Lower"),
    "Photo of Niko (1)":            LocData(LOC_ID_BASE + 62, "Refuge Lower"),
    "Photo of Niko (2)":            LocData(LOC_ID_BASE + 63, "Refuge Lower"),
    "Photo of Niko (3)":            LocData(LOC_ID_BASE + 64, "Refuge Lower"),
    "Photo of Niko (4)":            LocData(LOC_ID_BASE + 65, "Refuge Lower"),
    "Photo of Niko (5)":            LocData(LOC_ID_BASE + 66, "Refuge Lower"),
    "Photo of Niko (6)":            LocData(LOC_ID_BASE + 67, "Refuge Lower"),
    "Photo of Niko (Blink)":        LocData(LOC_ID_BASE + 68, "Refuge Lower"),
    "Photo of Niko (7)":            LocData(LOC_ID_BASE + 69, "Refuge Lower"),
    "Photo of Niko (8)":            LocData(LOC_ID_BASE + 70, "Refuge Lower"),
    "Photo of Niko (9)":            LocData(LOC_ID_BASE + 71, "Refuge Lower"),
    "Water Pill":                   LocData(LOC_ID_BASE + 73, "Refuge Lower"),
    "Die":                          LocData(LOC_ID_BASE + 74, "Refuge Lower"),
}
...
# ── Crafts ────────────────────────────────────────────────────────────────────
crafts_locations = {
    "Wet Branch":                   LocData(LOC_ID_BASE + 100, "Starter House"),
    ...
    "Wet Sponge":                   LocData(LOC_ID_BASE + 108, "Barrens"),
    "Lens":                         LocData(LOC_ID_BASE + 109, "Barrens"),
    "Empty Battery":                LocData(LOC_ID_BASE + 110, "Barrens"),
    "Charged Battery":              LocData(LOC_ID_BASE + 111, "Barrens"),
    "Feather Pen":                  LocData(LOC_ID_BASE + 112, "Glen"),
    "Button (?)":                   LocData(LOC_ID_BASE + 113, "Refuge Upper"),
    "Magnetized Button":            LocData(LOC_ID_BASE + 114, "Refuge Upper"),
    "Taped Button":                 LocData(LOC_ID_BASE + 115, "Refuge Upper"),
    "Niko's Library Card":          LocData(LOC_ID_BASE + 116, "Refuge Lower"),
#    "Sticky Photo":                 LocData(LOC_ID_BASE + 117, "Refuge Lower"),
    "Medicated Water":              LocData(LOC_ID_BASE + 118, "Refuge Lower"),
}
...
wallpapers_locations = {
    ...
    "Wallpaper: Catwalks":          LocData(LOC_ID_BASE + 305, "Refuge Upper"),
    "Wallpaper: Library Stroll":    LocData(LOC_ID_BASE + 306, "Refuge Lower"),
    "Wallpaper: Secret RAM Club":   LocData(LOC_ID_BASE + 307, "Refuge Lower"),
    "Wallpaper: Lamplighter":       LocData(LOC_ID_BASE + 308, "Refuge Lower"),
    "Wallpaper: Cafe":              LocData(LOC_ID_BASE + 309, "Refuge Lower"),
    "Wallpaper: Maize":             LocData(LOC_ID_BASE + 310, "Refuge Lower"),
...
friends_locations = {
    ...
    "Profile: Mason":             LocData(LOC_ID_BASE + 407, "Refuge Upper"),
    "Profile: Watcher":           LocData(LOC_ID_BASE + 408, "Refuge Upper"),
    "Profile: Kelvin":            LocData(LOC_ID_BASE + 409, "Refuge Lower"),
    "Profile: Shepherd":          LocData(LOC_ID_BASE + 410, "Refuge Lower"),
    "Profile: Kip":               LocData(LOC_ID_BASE + 411, "Refuge Lower"),
    "Profile: George":            LocData(LOC_ID_BASE + 412, "Refuge Lower"),
...
themes_locations = {
    ...
    "Theme: Pink":                LocData(LOC_ID_BASE + 505, "Refuge Lower"),
    "Theme: Orange":              LocData(LOC_ID_BASE + 506, "Refuge Lower"),
    "Theme: White":               LocData(LOC_ID_BASE + 507, "Refuge Lower"),
...
badges_locations = {
    ...
    "Badge: Bookworm":            LocData(LOC_ID_BASE + 606, "Refuge Lower"),
    "Badge: Pancakes":            LocData(LOC_ID_BASE + 607, "Refuge Lower"),
